...
CREATE OR REPLACE FUNCTION "public"."get_rink"("rink_id" integer) RETURNS TABLE("id" integer, "district_id" integer, "name" "text", "description" "text", "type" "text", "rink_name" "text", "latitude" double precision, "longitude" double precision, "updated_at" timestamp without time zone, "public_static_map_url" "text", "schedules" "jsonb", "services" "text"[], "information" "text", "address" "text", "description_fr" "text", "description_en" "text", "name_fr" "text", "name_en" "text", "information_fr" "text", "information_en" "text", "is_active" boolean, "district" "jsonb", "conditions_history" "jsonb", "last_open_true" timestamp without time zone, "last_cleared_true" timestamp without time zone, "last_watered_true" timestamp without time zone, "last_resurfaced_true" timestamp without time zone)
    LANGUAGE "sql"
    AS $$ 
WITH RINKS AS (
    SELECT
...
ALTER FUNCTION "public"."get_rink"("rink_id" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."nearby_rinks"("latitude_search" double precision, "longitude_search" double precision, "page" integer DEFAULT 1) RETURNS TABLE("id" integer, "name" "text", "distance" double precision, "rink_type" "text", "description" "text", "description_fr" "text", "description_en" "text", "rink_name" "text", "longitude" double precision, "latitude" double precision, "district_name" "text", "conditions" "jsonb", "last_update" timestamp without time zone)
    LANGUAGE "sql"
    AS $$ WITH RINK_DISTANCE AS (
    SELECT
        rinks.id,
        rinks.name,
...
ALTER FUNCTION "public"."nearby_rinks"("latitude_search" double precision, "longitude_search" double precision, "page" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."search_rinks"("q" "text", "latitude_search" double precision, "longitude_search" double precision) RETURNS TABLE("id" integer, "name" "text", "distance" double precision, "rink_type" "text", "description" "text", "description_fr" "text", "description_en" "text", "rink_name" "text", "longitude" double precision, "latitude" double precision, "district_name" "text", "conditions" "jsonb", "last_update" timestamp without time zone)
    LANGUAGE "sql"
    AS $$ 
...
ALTER FUNCTION "public"."search_rinks"("q" "text", "latitude_search" double precision, "longitude_search" double precision) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."search_rinks_all"("q" "text", "latitude_search" double precision, "longitude_search" double precision) RETURNS TABLE("id" integer, "name" "text", "distance" double precision, "rink_type" "text", "description" "text", "description_fr" "text", "description_en" "text", "rink_name" "text", "longitude" double precision, "latitude" double precision, "district_name" "text", "conditions" "jsonb", "last_update" timestamp without time zone)
    LANGUAGE "sql"
    AS $$ 
WITH RINK_DISTANCE AS (
    SELECT
...
ALTER FUNCTION "public"."search_rinks_all"("q" "text", "latitude_search" double precision, "longitude_search" double precision) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."conditions" (
    ...
    "resurfaced" boolean DEFAULT false NOT NULL,
    "condition" "text" DEFAULT 'NA'::"text" NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS "public"."rink_conditions_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE "public"."rink_conditions_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."rink_conditions_id_seq" OWNED BY "public"."conditions"."id";



CREATE TABLE IF NOT EXISTS "public"."rink_group_rink" (
    "id" bigint NOT NULL,
    "rink_group_id" bigint,
    "rink_id" integer
);


ALTER TABLE "public"."rink_group_rink" OWNER TO "postgres";


ALTER TABLE "public"."rink_group_rink" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."rink_group_rink_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."rink_groups" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "district_id" integer,
    "name" "text",
...
ALTER TABLE "public"."rink_groups" OWNER TO "postgres";


COMMENT ON TABLE "public"."rink_groups" IS 'represent a group of rink';



COMMENT ON COLUMN "public"."rink_groups"."public_static_map_url" IS 'image url';



ALTER TABLE "public"."rink_groups" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."rink_groups_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."rink_update" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "rink_id" integer,
    "update_method" "text",
...
ALTER TABLE "public"."rink_update" OWNER TO "postgres";


COMMENT ON TABLE "public"."rink_update" IS 'data to update rinks';



ALTER TABLE "public"."rink_update" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."rink_update_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."rinks" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."rinks_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE "public"."rinks_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."rinks_id_seq" OWNED BY "public"."rinks"."id";



CREATE TABLE IF NOT EXISTS "public"."static-map" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "public_url" "text",
    "cache_key" "text"
...
ALTER TABLE "public"."static-map" OWNER TO "postgres";


ALTER TABLE "public"."static-map" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."static-map_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."conditions" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."rink_conditions_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."rinks" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."rinks_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."districts"
    ADD CONSTRAINT "districts_district_code_key" UNIQUE ("code");
...
ALTER TABLE ONLY "public"."conditions"
    ADD CONSTRAINT "rink_conditions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rink_group_rink"
    ADD CONSTRAINT "rink_group_rink_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rink_groups"
    ADD CONSTRAINT "rink_groups_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rink_update"
    ADD CONSTRAINT "rink_update_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rinks"
    ADD CONSTRAINT "rinks_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."static-map"
    ADD CONSTRAINT "static-map_cache_key_key" UNIQUE ("cache_key");



ALTER TABLE ONLY "public"."static-map"
    ADD CONSTRAINT "static-map_pkey" PRIMARY KEY ("id");



CREATE INDEX "idx_rinks_location" ON "public"."rinks" USING "gist" ("location");



ALTER TABLE ONLY "public"."districts"
    ADD CONSTRAINT "districts_citie_id_fkey" FOREIGN KEY ("citie_id") REFERENCES "public"."cities"("id");



ALTER TABLE ONLY "public"."conditions"
    ADD CONSTRAINT "rink_conditions_rink_id_fkey" FOREIGN KEY ("rink_id") REFERENCES "public"."rinks"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rink_group_rink"
    ADD CONSTRAINT "rink_group_rink_rink_group_id_fkey" FOREIGN KEY ("rink_group_id") REFERENCES "public"."rink_groups"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rink_group_rink"
    ADD CONSTRAINT "rink_group_rink_rink_id_fkey" FOREIGN KEY ("rink_id") REFERENCES "public"."rinks"("id");



ALTER TABLE ONLY "public"."rink_groups"
    ADD CONSTRAINT "rink_groups_district_id_fkey" FOREIGN KEY ("district_id") REFERENCES "public"."districts"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."rink_update"
    ADD CONSTRAINT "rink_update_rink_id_fkey" FOREIGN KEY ("rink_id") REFERENCES "public"."rinks"("id");



ALTER TABLE ONLY "public"."rinks"
    ADD CONSTRAINT "rinks_district_id_fkey" FOREIGN KEY ("district_id") REFERENCES "public"."districts"("id") ON DELETE CASCADE;



CREATE POLICY "All user can read" ON "public"."conditions" FOR SELECT USING (true);



CREATE POLICY "All user can read" ON "public"."rinks" FOR SELECT USING (true);



CREATE POLICY "Anon" ON "public"."static-map" TO "anon" USING (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."rink_group_rink" FOR SELECT USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."rink_groups" FOR SELECT USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."static-map" FOR SELECT USING (true);



CREATE POLICY "Read all users" ON "public"."districts" FOR SELECT USING (true);
...
ALTER TABLE "public"."rink_group_rink" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."rink_groups" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."rink_update" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."rinks" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."static-map" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "update " ON "public"."districts" TO "anon" USING (true);
...
GRANT ALL ON FUNCTION "public"."get_rink"("rink_id" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_rink"("rink_id" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_rink"("rink_id" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."nearby_rinks"("latitude_search" double precision, "longitude_search" double precision, "page" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."nearby_rinks"("latitude_search" double precision, "longitude_search" double precision, "page" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."nearby_rinks"("latitude_search" double precision, "longitude_search" double precision, "page" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."search_rinks"("q" "text", "latitude_search" double precision, "longitude_search" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."search_rinks"("q" "text", "latitude_search" double precision, "longitude_search" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_rinks"("q" "text", "latitude_search" double precision, "longitude_search" double precision) TO "service_role";



GRANT ALL ON FUNCTION "public"."search_rinks_all"("q" "text", "latitude_search" double precision, "longitude_search" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."search_rinks_all"("q" "text", "latitude_search" double precision, "longitude_search" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_rinks_all"("q" "text", "latitude_search" double precision, "longitude_search" double precision) TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."rink_conditions_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."rink_conditions_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."rink_conditions_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."rink_group_rink" TO "anon";
GRANT ALL ON TABLE "public"."rink_group_rink" TO "authenticated";
GRANT ALL ON TABLE "public"."rink_group_rink" TO "service_role";



GRANT ALL ON SEQUENCE "public"."rink_group_rink_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."rink_group_rink_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."rink_group_rink_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."rink_groups" TO "anon";
GRANT ALL ON TABLE "public"."rink_groups" TO "authenticated";
GRANT ALL ON TABLE "public"."rink_groups" TO "service_role";



GRANT ALL ON SEQUENCE "public"."rink_groups_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."rink_groups_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."rink_groups_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."rink_update" TO "anon";
GRANT ALL ON TABLE "public"."rink_update" TO "authenticated";
GRANT ALL ON TABLE "public"."rink_update" TO "service_role";



GRANT ALL ON SEQUENCE "public"."rink_update_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."rink_update_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."rink_update_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."rinks" TO "anon";
GRANT ALL ON TABLE "public"."rinks" TO "authenticated";
GRANT ALL ON TABLE "public"."rinks" TO "service_role";



GRANT ALL ON SEQUENCE "public"."rinks_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."rinks_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."rinks_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."static-map" TO "anon";
GRANT ALL ON TABLE "public"."static-map" TO "authenticated";
GRANT ALL ON TABLE "public"."static-map" TO "service_role";



GRANT ALL ON SEQUENCE "public"."static-map_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."static-map_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."static-map_id_seq" TO "service_role";
